...
const projects = {
  ...
  rbac: {
    projectName: "RBAC Design for a Microservices Architecture (University Final Project)",
  ...
  pollApp: {
    ...
    list: [
      {
        heading: "Manage Team",
        description: "As the Project Manager for this project, I managed meeting schedules and delegated tasks to team members according to their individual skills."
      },
      {
        heading: "Backend",
